         ...
         <div class="form-group">
            ...
            <form method= "GET" action = "requisicoes_validar.php">  
                <div class="row">
                    ...
                    <div class="col-6 col-sm-3 text-center col-md-3 col-lg-3">                        
                        <input type=submit  class="btn btn-primary"onclick="window.location.href='requisicoes_validar.php'" value="Deletar multiplos">
                    </div>
                    <div class="col-6 col-sm-3 text-center col-md-3 col-lg-3">                        
                        <button type="submit" class="btn btn-primary">Exportar</button>
                    </div>
                    <div class="col-6 col-sm-3 text-center col-md-3 col-lg-3">                        
                        <input type="button" value="Adicionar" class="btn btn-primary" onclick="window.location.href='requisicoes_validar.php'" >
                    </div>
                </div>
                        ...
                        <tbody>
                            <tr>
                                <?php   while ($list_1 = $stmt_1->fetch(PDO::FETCH_ASSOC)):?>
                                    ...
                                    <td>
                                        <input type="checkbox" value ="<?php echo($list_1['id']); echo($list_1['iduser']);?>" name='box[]'>
                                    </td>
                            </tr>
                            <?php endwhile; ?>
                        </tbody>    
